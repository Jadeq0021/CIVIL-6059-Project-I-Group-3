...
//    {
//        double area = 40 * 3.2808399 * 3.2808399;
//        double wallThickness = UnitUtils.Convert(0.2, DisplayUnitType.DUT_METERS, DisplayUnitType.DUT_DECIMAL_FEET);
...
//            UV point_2 = new UV(length, 0);
//            UV point_3 = new UV(length, length*2);
//            UV point_4 = new UV(0, length*2);
//            // 2-dimensional boundary points of module_2
//            UV point_5 = new UV(length, 0);
//            UV point_6 = new UV(length * 2, 0);
//            UV point_7 = new UV(length * 2, length * 2);
//            UV point_8 = new UV(length, length * 2);
//            // create modules
